...
/***/ "./node_modules/angular-date-value-accessor/date-value-accessor.js":
...
/***/ "./node_modules/angular-date-value-accessor/index.js":
/***/ (function(module, exports, __webpack_require__) {
...
__export(__webpack_require__("./node_modules/angular-date-value-accessor/module.js"));
__export(__webpack_require__("./node_modules/angular-date-value-accessor/date-value-accessor.js"));
//# sourceMappingURL=index.js.map

/***/ }),

/***/ "./node_modules/angular-date-value-accessor/module.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";

var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var date_value_accessor_1 = __webpack_require__("./node_modules/angular-date-value-accessor/date-value-accessor.js");
...
/***/ "./src/app/search-box/filter.pipe.ts":
/***/ (function(module, exports, __webpack_require__) {
...
module.exports = "<div id='search-box'>\n    <div id='upcoming'>\n        <h1>Search for upcoming flights</h1>\n        <form #f=\"ngForm\" (ngSubmit)=\"onSubmit(f)\">\n            <div id='source'>\n                <p>Source</p>\n                <input type='text' (ngModelChange)=\"toggleSourceDisplay();\" name='source' placeholder='airport, city' autocomplete=\"off\"\n                    [(ngModel)]='source' required>\n                <div id='source-search' class='filter-airport' [style.display]='sourceDisplay'>\n                    <ul>\n                        <li *ngFor=\"let each of airport|filter:source\">\n                            <div (click)=\"this.source=each.airport;this.sourceDisplay='none'\">{{each.airport}}, {{each.city}}</div>\n                        </li>\n                    </ul>\n                </div>\n            </div>\n            <div id='destination'>\n                <p>Destination</p>\n                <input type='text' (ngModelChange)=\"toggleDestinationDisplay();\" name='destination' placeholder='airport, city' autocomplete=\"off\"\n                    [(ngModel)]='destination' required>\n                <div id='destination-search' class='filter-airport' [style.display]='destinationDisplay'>\n                    <ul>\n                        <li *ngFor=\"let each of airport|filter:destination\">\n                            <div (click)=\"this.destination=each.airport;this.destinationDisplay='none'\">{{each.airport}}, {{each.city}}</div>\n                        </li>\n                    </ul>\n                </div>\n            </div>\n            <div id='date'>\n                <p>Date</p>\n                <input type='date' name='date' [(ngModel)]='date' useValueAsDate required>\n            </div>\n            <div (click)=\"onSubmit(f)\" id='search'>\n                <i class='material-icons'>search</i>\n            </div>\n        </form>\n        <div id='validation'>\n            <p>{{validation}}</p>\n        </div>\n    </div>\n    <div id='status'>\n        <h1>Search for flight status</h1>\n        <form #f1=\"ngForm\" (ngSubmit)=\"onSubmit1(f1)\">\n            <div id='flight-num'>\n                <p>Flight #</p>\n                <input type='text' name='flight_num' placeholder='flight #' ngModel required>\n            </div>\n            <div id='arrival'>\n                <p>Arrival</p>\n                <input type='date' name='arrival' [(ngModel)]='date1' useValueAsDate required>\n            </div>\n            <div id='departure'>\n                <p>Departure</p>\n                <input type='date' name='departure' [(ngModel)]='date2' useValueAsDate required>\n            </div>\n            <div (click)=\"onSubmit1(f1)\" id='search1'>\n                <i class='material-icons'>search</i>\n            </div>\n        </form>\n    </div>\n</div>"
...
var SearchBoxComponent = /** @class */ (function () {
    ...
    SearchBoxComponent.prototype.onSubmit1 = function (f1) {
        var _this = this;
        if (!f1.valid) {
            this.validation = 'Please fill in all the blanks';
            return;
        ...
        this.validation = '';
        this.date.setHours(this.date.getHours() + (this.date.getTimezoneOffset() / 60));
        this.http.post('/getFlightStatus', f1.value, { responseType: 'text' }).subscribe(function (res) {
            _this.source = _this.destination = '';
            _this.cookie.set('reload', '/search');
            _this.router.navigate(['/reload']);
        });
    ...
    SearchBoxComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.http.get('/airport', { responseType: 'json' }).subscribe(function (res) {
            _this.airport = res;
        });
    };
...
/***/ "./src/app/search-box/search-box.module.ts":
/***/ (function(module, exports, __webpack_require__) {
...
var search_box_component_1 = __webpack_require__("./src/app/search-box/search-box.component.ts");
var forms_1 = __webpack_require__("./node_modules/@angular/forms/esm5/forms.js");
var filter_pipe_1 = __webpack_require__("./src/app/search-box/filter.pipe.ts");
...
var SearchBoxModule = /** @class */ (function () {
    ...
    SearchBoxModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, forms_1.FormsModule, angular_date_value_accessor_1.DateValueAccessorModule],
            declarations: [search_box_component_1.SearchBoxComponent, filter_pipe_1.FilterPipe],
            exports: [forms_1.FormsModule, search_box_component_1.SearchBoxComponent]
        })
    ], SearchBoxModule);
